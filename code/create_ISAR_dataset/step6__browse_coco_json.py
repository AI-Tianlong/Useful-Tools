...
def parse_args():
    ...
    parser.add_argument(
        '--img-dir', default='/media/atl/Data1/ATL/AI_work/ISAR/Dataset/ATL_ISAR/val/images', help='image folder path')
    parser.add_argument(
        '--ann-file',
        default='/media/atl/Data1/ATL/AI_work/OpenMMLab/mmyolo/work_dirs/ATL_yolov8_s_ATL_ISAR/bbox.json',
        help='ann file path')
    parser.add_argument(
