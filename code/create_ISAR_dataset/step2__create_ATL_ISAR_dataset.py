...
img_root_path = r'D:\ATL\AI_work\ISAR\Dataset\SynISAR_no_background'   # 原始数据集的根目录
new_img_save_root_path = r'D:\ATL\AI_work\ISAR\Dataset\ATL_ISAR'        # 要生成数据集的根目录

num_train_images = 3000    # 要生成的数据集的张数
num_val_images = 1000    # 要生成的数据集的张数
