...
if __name__ == "__main__":
    ...
    parser.add_argument("-image_path", type=str, default=r'/root/master/ATL/code/code/结果图/Vaihingen/acbisenetv6/one/label/0.tif')
...
#     label.save('vis.png')
    img = Image.open(r'/root/master/ATL/dataset/Vaihingen_1024/Val/image/1.tif').convert('RGBA')
