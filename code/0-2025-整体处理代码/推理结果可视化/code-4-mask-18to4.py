...
if __name__ == '__main__':
    ...
    New_Label_Save_Path = '../results_mask_4_geo/'
    ...
    convert_dict=dict(
        ...
        class_1 = [1,2,3,4,5],
        class_2 = [6,7,8],
        class_3 = [9,10,11,12,13,14,15,16,17],
        class_4 = [18],
        class_5 = [19],
    ...
    for old_label_path_ in tqdm(old_label_list, colour='Green'):
        new_label_save_path = os.path.join(New_Label_Save_Path, os.path.basename(old_label_path_).replace('_18label'+suffix, '_4label'+suffix))
        convert_19_to_5_classes(old_label_path_, new_label_save_path, convert_dict, class_drop, with_geo = True)
